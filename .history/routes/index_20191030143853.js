...
router.post('/log', function(req, res) {
  ...
  db.get('usercollection').find({unsermail}, function(err, result) {
    //if (err) throw err;
    if(req.body.logemail == result.email && req.body.logemail == result.userpassword){
      session.uniqueID == req.body.logemail;
    }
    //res.redirect('/redirects');
    res.end(result.email +'Erreur'+err);
  });
});
