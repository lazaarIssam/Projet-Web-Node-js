...
exports.questionpage = function(req, res) {
    ...
    db.collection('annoncecollection').findOne({"_id":idannonce},function(err,data){
        res.render('question',{"clientid": req.body.iduser,"annonceid": req.body.idannonce,"idagent": req.body.idagent,"emailclient":req.body.emailclient});
    })
}
