...
exports.restoclient= function(req,res){
    ...
    db.collection('questioncollection').findOne({"_id":idannonce},function(err,result){
        db.collection('usercollection').findOne({"_id":result.client_id},function(err,client){
            db.collection('annoncecollection').findOne({"_id":result.annonce_id,"user.us_id":result.agent_id},function(err,annonce){
                res.send('value: '+annonce.titre +' agent: '+annonce.user.us_name);
            })
        })
    });
}
