...
exports.questionpage = function(req, res) {
    ...
    userid = req.body.idclient;
    annonceid = req.body.idannonce;
  res.render('question',{"us_id": req.body.us_id,"us_name": req.body.us_name,"us_email":req.body.us_email,"us_typecompte":req.body.us_typecompte});
}
