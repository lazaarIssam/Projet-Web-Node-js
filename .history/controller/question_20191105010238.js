...
exports.responseclient= function(req,res){
    ...
    db.collection('questioncollection').insert({"idannonce":idannonce,"agentresponse":agentresponse},function(err,response){
         res.render('conversation',{"response":response});
    })
}
