...
exports.login = function(req, res,next) {
  passport.authenticate('local', {
    successRedirect: db.get('annoncecollection').find({"user.us_email":req.body.email},function(err,annonce){
      db.get('usercollection').findOne({"user.us_id": result._id.toString()})
    }),
    failureRedirect: '/',
})(req, res, next);
} 
