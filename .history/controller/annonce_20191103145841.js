...
exports.updatep= function(req, res) {
  ...
  console.log('id annonce : '+ObjectId(myId));
  db.get('annoncecollection').find({"_id": ObjectId(myId)}).toArray.then((err, docs) => {
    console.log('title1: '+docs);
    if(docs){
      console.log('title: '+docs.titre);
