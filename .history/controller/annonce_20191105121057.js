...
exports.updateann= function(req, res) {
  ...
  db.get('annoncecollection').update({"_id":req.body.anoid}, newvalues,function(err, data) {
    ...
    //
    db.get('annoncecollection').find({"user.us_id": req.body.us_id},function(e, docs){
      res.render("dashboard",{"listannonceuser": data,"sesid":req.body.us_id,"sess":req.body.us_id,"u_id": req.body.us_id, "u_name": req.body.us_name, "u_email": req.body.us_email, "u_typecompte": req.body.us_typecompte});
    });
    //db.close();
  });
}
