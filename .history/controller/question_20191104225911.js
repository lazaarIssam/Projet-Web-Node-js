...
exports.restoclient= function(req,res){
    ...
    db.collection('questioncollection').findOne({"annonce_id":idannonce.toString()},function(err,result){
        //res.render('msgAgent',{"result": result.question});
        res.send('value: '+ result.objetmsg);
    });
}
