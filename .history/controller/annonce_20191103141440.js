...
exports.updatep= function(req, res) {
  var db = req.db;
  var anid =objectId(req.body.id);
  db.get('annoncecollection').findOne({"_id":anid},{},function(e, docs){
    res.render('updateAnn',{"annonce": docs});
}
//db.get('annoncecollection').findOneAndUpdate({"_id":anid},req.body, { new: true },function(err,docs){
//});