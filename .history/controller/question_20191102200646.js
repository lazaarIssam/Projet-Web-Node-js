...
exports.messagerieClient = function(req, res) {
    ...
    db.get('annoncecollection').find({"userid": clientid},function (e,result){
        res.render('messagerieClient',{"result":result,"sess": emailclient,"sesid": req.session.id,"iduser": userid});
      }); 
}
