  ...
  exports.insererAnnonce = function(req, res) {
      ...
      collection.insert({
          ...
          if (err) {
              ...
              res.render("dashboard",{"sesid":req.body.us_id,"sess":req.body.us_id,"u_id": req.body.us_id, "u_name": req.body.us_name, "u_email": result.email, "u_typecompte": result.typecompte});
          }
      });
  }